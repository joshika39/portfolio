...
- [Floorp Website](https://github.com/Floorp-Projects/web) - Contributed to the `Floorp` browser's website, enhancing its design and functionality.
...
- **Software Developer** – XperiCAD Kft. (Contract) _Jun 2021 – Present · Remote (Hungary)_
  - WPF, .NET, MVVM, Git, C#
